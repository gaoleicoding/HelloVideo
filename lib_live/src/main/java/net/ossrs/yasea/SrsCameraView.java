...
public class SrsCameraView extends GLSurfaceView implements GLSurfaceView.Renderer {
    private final String TAG = "SrsCameraView";
    ...
    private OnTakeFrameListener takeFrameListener;
    private int moveX;
    private int moveY;
    private int mScreenWidth;
    private int mScreenHeight;
    private List<Bitmap> bitmaps;
    private boolean isTakeCurrentFrame;
    ...
    public void onDrawFrame(final GL10 gl) {
        Log.d(TAG, "onDrawFrame gl:" + gl.hashCode());
    ...
    public void takeCurrentFrame(OnTakeFrameListener takeFrameListener) {
        this.takeFrameListener = takeFrameListener;
        isTakeCurrentFrame = true;
    }
    ...
    public interface OnTakeFrameListener {
        void onTakeFrame(Bitmap bitmap);
    }
